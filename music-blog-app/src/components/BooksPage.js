    ...
    retailers: [
      {
        ...
        logo: 'https://cdn4.iconfinder.com/data/icons/social-media-2146/512/31_social-512.png'
      }
    ]
  },
  
  // You can uncomment and add more book objects here
];
        ...
        <div className="booksGrid">
          {booksData.map(book => (
            <div key={book.id} className="bookCard">
              ...
              <a
                href={book.preorder_link}
                className="preorderButton"
                target="_blank"
                rel="noopener noreferrer"
              >
